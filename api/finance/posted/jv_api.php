...
if(isset($_POST['action']) && $_POST['action'] == 'view'){
    ...
    AND A.POSTED = 'Y' AND A.COMPANY_ID = '$company_id' AND A.PROJECT_ID = '$project_id' AND A.VTYPE = 'JV' 
    ...
    if(isset($_POST['id']) && !empty($_POST['id'])){
        ...
        WHERE B.ACTIVE = 'Y' AND C.ACTIVE = 'Y' AND A.VNO = '$id' AND A.VTYPE = 'JV' AND A.COMPANY_ID = '$company_id' 
        ...
        INNER JOIN COD_FISCAL_YEAR B ON B.SNO = A.FISCAL_YEAR
        INNER JOIN COD_DATE_LOCK C ON C.FISCAL_YEAR = A.FISCAL_YEAR 
        WHERE B.ACTIVE = 'Y' AND C.ACTIVE = 'Y' AND A.VNO = '$id' AND A.VTYPE = 'JV' AND A.COMPANY_ID = '$company_id' AND A.PROJECT_ID = '$project_id'";
