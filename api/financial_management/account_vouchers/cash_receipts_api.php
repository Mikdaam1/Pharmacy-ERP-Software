...
if(isset($_POST['action']) && $_POST['action'] == 'view'){
  // print_r("jfsksk");
    ...
    $master_q = "insert into acttran_mst(co_code,doc_year,voucher_type,voucher_no,voucher_date,bank_cash_code,naration,ref_no,sn_no,payee)value ('$company_code','$year','CR','$voucher_no','$voucher_date','$bank','$narration','$reference_no','$bank_ser_no','$monthwise_ser_no')";
  ...
  // print_r("jfsksk");
    ...
    // print_r("jfsksk");
      $company_code=$_POST['company_code'];
      $query = "SELECT account_code,descr FROM act_chart WHERE co_code='$company_code' 
