                ...
                <form method = "post" id = "city_form">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" type="number" name="cityCode" id="cityCode" class="form-control form-control-sm" placeholder="city Code" > 
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" type="number" name="cityCode_e" id="cityCode_e" class="form-control form-control-sm" placeholder="city Code" readonly> 
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="inputdescription">Description:</label><span style="color:red;">*</span>
...
$("#cs_breadcrumb").on("click", function () {
    $.get('Fixedassets/city_setup.php', function(data,status){
        $("#content").html(data);
    });
});
