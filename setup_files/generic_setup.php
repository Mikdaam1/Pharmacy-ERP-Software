                ...
                <form method = "post" id = "generic_form">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" type="number" name="genericCode" id="genericCode" class="form-control form-control-sm" placeholder="Generic Code" > 
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" type="number" name="genericCode_e" id="genericCode_e" class="form-control form-control-sm" placeholder="Generic Code" readonly> 
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="inputdescription">Description:</label><span style="color:red;">*</span>
...
$("#cs_breadcrumb").on("click", function () {
    $.get('Fixedassets/generic_setup.php', function(data,status){
        $("#content").html(data);
    });
});
