                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" pattern="[0-9]+"  tabindex="-1" minlength = "4" maxlength = "4" name="sub_control_code" id="sub_control_code" class="form-control form-control-sm" placeholder="Control Code">
                      </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}"  tabindex="-1" maxlength="30" type="text" name="sub_control_name" id="sub_control_name" class="form-control form-control-sm" placeholder="Account Name" >
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input pattern="[a-zA-Z0-9 ,._-]{1,}"  tabindex="-1" maxlength="30" type="text" name="sub_control_name_e" id="sub_control_name_e" class="form-control form-control-sm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
