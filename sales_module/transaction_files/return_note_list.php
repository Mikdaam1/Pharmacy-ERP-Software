...
$("#example1").on('click','.btn-select',function(){
    ...
    $.get('sales_module/transaction_files/invoice_edit.php?co_code='+co_code+'&doc_no='+doc_no+'&po_catg='+po_catg+'&doc_year='+doc_year+'&party_code='+party_code+'&div_code='+div_code+'&salesman_code='+salesman_code+'&po_no='+po_no, function(data,status){
        $("#content").html(data);
    });
});
