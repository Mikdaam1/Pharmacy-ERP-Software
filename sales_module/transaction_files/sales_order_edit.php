    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="edit_sale_orer_breadcrumb">Edit Sale Order</button></li>
                </ol>
            </div>   
            </div>
        </div><!-- /.container-fluid -->
            ...
            success: function(data){
                ...
                if(data.length >= 1){
                    for(var i=1;i<=data.length;i++){
                      $('#d_items tr:last').before('<tr id="tr'+i+'"><td><select name="acc_desc[]" id = "acc_desc'+i+'" class="js-example-basic-single acc_desc"></td><td><textarea  rows="1" name="detail[]" id = "detail'+i+'" class="detail" readonly></textarea></td><td ><select style="font-size:9px !important;width:75px !important;height:35px" name="type[]" id = "type'+i+'" class="type"><option value="0" readonly="readonly" selected>Type</option><option value="N">N</option><option value="F">F</option><option value="S">S</option><option value="T">T</option></select></td><td><input style="width:83px !important;height:35px !important;" type="number" name="quantity[]" id = "quantity'+i+'" class="quantity" ></td><td><input style="width:100px !important;height:35px !important" type="text" name="rate[]" id = "rate'+i+'"  class="rate" ></td><td><input style="width:100px !important;height:35px !important;background-color:#b7edea" type="text" name="amount[]" id = "amount'+i+'" class="total" readonly></td><td><input style="width:100px !important;height:35px !important;background-color:#ccd4e1" type="text" name="division_i[]" id = "division_i'+i+'" class="division_i" readonly></td><td><input style="width:100px !important;height:35px !important;background-color:#ccd4e1" type="text" name="gen_i[]" id = "gen_i'+i+'" class="gen_i" readonly></td><td><input style="width:100px !important;height:35px !important;background-color:#ccd4e1" type="text" name="um_i[]" id = "um_i'+i+'" class="um_i" readonly></td><td><button type = "button" id="'+i+'" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');          
                                  ...
                                  $('#acc_desc'+j).val(data[l].item_code);
                                    $.ajax({
                                        ...
                                        success: function(datas){
                                            console.log(l);
                                            $('#division_i'+j).val(datas.division_name);
