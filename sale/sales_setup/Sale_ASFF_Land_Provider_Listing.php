...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Land Providers</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <!-- <li class="breadcrumb-item"><a class="btn btn-sm"  href = "web-api/logout/logout.php">LOGOUT</a></li> -->
                <li class="breadcrumb-item active"><button class="btn btn-sm" id="land_provider_breadcrumb">Land Provider List</button></li>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-11">
                      <h3 class="card-title">Land Provider Records</h3>
                    </div>
                    <div class="col-sm-1">
                          <div class="col-sm-12 text-right">
                            <button type="button" class="btn btn-info mt-2 btn-sm 402c2a_1" id="add_button" style="display:none;">  
