    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Land Provider Registration</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <!-- <li class="breadcrumb-item"><a class="btn btn-sm"  href = "web-api/logout/logout.php">LOGOUT</a></li> -->
                    <li class="breadcrumb-item active"><button class="btn btn-sm" id="land_provider_breadcrumb">Land Provider Registration</button></li>
                    <li class="breadcrumb-item"><button class="btn btn-sm" id="land_provider_list_breadcrumb">Land Provider List</button></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            <div class="card-body">
                                <form method="post" id="sale_ASFFLandProviderRegistrationForm">
...
$(document).ready(function(){
    ...
    $("#sale_ASFFLandProviderRegistrationForm").on('submit',function(e){
        e.preventDefault();
        let request = $(this).serialize();
        let action = 'store';
        $.ajax({
            url: 'api/sales/SalesSetups/LandProviderRegistration/ActionsHandler.php',
            type: 'POST',
            dataType: "json",
            ...
            success: function(response){
                if(response)
                {
                    var message = "Land Provider Successfully";
                    var status = 1;
                    $.ajax({
                ...
                $( '#sale_ASFFLandProviderRegistrationForm' ).each(function(){
                    this.reset();
                });
            },
            error: function(error) {
    ...
    $("#land_provider_breadcrumb").on("click", function() {
        $.get('sale/sales_setup/Sale_ASFF_Land_Provider.php', function(data,status){
            $("#content").html(data);
        });
    });
    $("#land_provider_list_breadcrumb").on("click", function() {
        $.get('sale/sales_setup/Sale_ASFF_Land_Provider_Listing.php', function(data,status){
            $("#content").html(data);
        });
    });
