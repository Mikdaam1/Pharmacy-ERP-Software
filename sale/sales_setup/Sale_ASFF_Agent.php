          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><button class="btn btn-sm" id="agent_breadcrumb">Agent</button></li>
                    <!-- <li class="breadcrumb-item"><button class="btn btn-sm" id="agent_list_breadcrumb">Agent List</button></li> -->
    ...
    $("#sale_ASFFDealerRegistrationForm").on('submit',function(e){
        ...
        $.ajax({
                ...
                success: function(response){
                    if(response)
                    {
                        var message = "ASFF Agent Successfully";
                        var status = 1;
                        $.ajax({
...
// $('#agent_list_breadcrumb').click(function(){
//     $.get('sale/sales_setup/Sale_ASFF_Agent_Listing.php', function(data,status){
//         $('#content').html(data);
//     });
// });
