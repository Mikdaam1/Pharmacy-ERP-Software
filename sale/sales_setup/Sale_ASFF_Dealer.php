        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active"><button class="btn btn-sm" id="dealers_breadcrumb">Dealer Registration</button></li>
                <!-- <li class="breadcrumb-item"><button class="btn btn-sm" id="dealers_list_breadcrumb">Dealers List</button></li> -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            <div class="card-body">
                                <form method="post" id="sale_ASFFDealerRegistrationForm">
...
$(document).ready(function(){
    ...
    $("#sale_ASFFDealerRegistrationForm").on('submit',function(e){
        e.preventDefault();
        let request = $(this).serialize();
        let action = 'store';
        $.ajax({
                url: 'api/sales/SalesSetups/DealerRegistration/ActionsHandler.php',
                type: 'POST',
                dataType: "json",
                ...
                success: function(response){
                    if(response)
                    {
                        var message = "ASFF Dealer Successfully";
                        var status = 1;
                        $.ajax({
                    ...
                    $( '#sale_ASFFDealerRegistrationForm' ).each(function(){
                        this.reset();
                    });
                },
                error: function(error) {
...
// $('#dealers_list_breadcrumb').click(function(){
//     $.get('sale/sales_setup/Sale_ASFF_Dealer_Listing.php', function(data,status){
//         $('#content').html(data);
//     });
// });
$('#dealers_breadcrumb').click(function(){
    $.get('sale/sales_setup/Sale_ASFF_Dealer.php', function(data,status){
        $('#content').html(data);
    });
});
