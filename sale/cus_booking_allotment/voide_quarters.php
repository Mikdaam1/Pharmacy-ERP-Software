        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><button class="btn btn-sm" id="voide_quarter_breadcrumb">Voide Quarter</button></li>
...
$('#example1').ready(function(){
    ...
    $.ajax({
        url: 'api/sales/cus_voide_quarter_api.php',
        type: 'POST',
        data: {action: 'voide_quarter'},
...
$("#voide_quarter_breadcrumb").on("click", function() {
