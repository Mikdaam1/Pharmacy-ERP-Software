...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Quarter Invoices</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <!-- <li class="breadcrumb-item"><a class="btn btn-sm"  href = "web-api/logout/logout.php">LOGOUT</a></li> -->
              <li class="breadcrumb-item active"><button class="btn btn-sm" id="quarter_inv_breadcrumb">Quarter Invoices</button></li>
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
                <form id="checkbox_form" action="invoicereports/quarter_invoices.php" method="post" target="blank">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    ...
                                    <button type="submit" class="btn btn-primary bulk_inv_btn 402a4c_1">Download/Print Invoice</button>
                                </div>
                            </div>
                            <div class="row">
...
if(jQuery.inArray("402a4c_1", secF_dataArr) !== -1){
    $('.402a4c_1').show();
}
...
$('#example1').ready(function(){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            var checkbtn = checkboxes;
            // var btn = schedule_btn+inv_btn;
            table.row.add([checkbtn,s_no,form_no,sale_id,schedule_date,due_date,amount,schedule_amount,type]);
            }
            table.draw();
        },
    ...
    $("#all_check").click(function() {
        ...
        // debugger;
        if($('input:checked', rows).length == 500){
            $('input[type="checkbox"]', rows).slice(0,500).prop('checked', false);
        }
        else{
            console.log(rows.length);
            $('input[type="checkbox"]', rows).slice(0,500).prop('checked', true);
...
$("#checkbox_form").on('click','.bulk_inv_btn',(function() {
    $("#error_msg").text("");
    ...
    if(ck_box < 1){
        $("#error_msg").text("please check at least one invoice");
    }else{
