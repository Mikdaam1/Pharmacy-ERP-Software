<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Complete Files</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <!-- <li class="breadcrumb-item"><a class="btn btn-sm"  href = "web-api/logout/logout.php">LOGOUT</a></li> -->
              <li class="breadcrumb-item active"><button class="btn btn-sm" id="complete_file_breadcrumb">Complete Files</button></li>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <?php include '../../display_message/display_message.php'?>
                  <div class="row">
                    <div class="col-sm-6">
                      <h3 class="card-title">Complete Files Customers Record</h3>
                    </div>
                  </div> 
                </div>
                <!-- /.card-header -->
...
$('#example1').ready(function(){
    ...
    $.ajax({
        url: 'api/sales/complete_files_api.php',
        type: 'POST',
        data: {action: 'complete_files'},
...
$("#complete_file_breadcrumb").on("click", function() {
