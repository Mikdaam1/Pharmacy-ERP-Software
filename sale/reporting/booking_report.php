    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Booked Reporting</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active"><button class="btn btn-sm" id="booking_breadcumb">Booked Reporting</button></li>
        ...
        success: function(response){
            ...
            for (var i=0; i<response.length; i++) {
                $('#search_type').append($('<option>', {  
                    value: response[i].SALE_STATUS,
                    text : response[i].SALE_STATUS
                }));
            }
        },
...
// breadcrumbs
$('#booking_breadcumb').click(function(){
