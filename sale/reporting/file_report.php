    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>File Reporting</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active"><button class="btn btn-sm" id="file_breadcumb">File Reporting</button></li>
                                            ...
                                            <div class="col-sm-6 form-group text-center">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <select class="form-control" name = "search_type" id="search_type">
                                                        ...
                                                        <option value="null">For Category</option>
    ...
    $('#quick_search_form').ready(function(e){
        $("#quick_search_form").on('submit',(function(e) {
            if ($(this).valid()) {
                ...
                $.ajax({
                    url: 'api/sales/reporting/file_report_api.php',
                    type:'POST',
                    ...
                    success: function(response) {
                        ...
                        if(response == ''){
                            ...
                            for (var i = 0; i < response.length; i++) {
                                ...
                                var sale_status = response[i].CONTRACT_ID??'-';
