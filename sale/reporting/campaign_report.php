    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Registration By Campaign</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active"><button class="btn btn-sm" id="campaign_breadcumb">Campaign Reporting</button></li>
...
$('#category_data').ready(function(){
    ...
    $.ajax({
        url: 'api/sales/reporting/campaign_report_api.php',
        type: 'POST',
        data: {action: 'index'},
        success: function(response){
            ...
            for (var i=0; i<response.length; i++) {
                $('#search_type').append($('<option>', {  
                    value: response[i].CAMPAIGN,
                    text : response[i].REMARKS
                }));
            }
        },
...
// breadcrumbs
$('#campaign_breadcumb').click(function(){
