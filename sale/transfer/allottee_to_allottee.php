                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-3 402b2a" style="display: none;">
                                                        <button class="btn" id="allottee_to_allottee_form_check"> <i class="fa fa-plus"></i> Transfer</button>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3 402b2c" style="display: none;">
                                                        <button class="btn" id="allottee_to_allottee_capture_image"> <i class="fa fa-image"></i> Capture Image</button>
                                                    </div>
...
$('document').ready(function(){
    ...
    $('#allottee_to_allottee_capture_image').click(function(){
        $(this).css('pointer-events','none');
        $(this).find($(".fa")).removeClass('fa-image').addClass('fa-spin fa-refresh');
        $.get('sale/transfer/allottee_to_allottee_image.php',function(data,status){
            $('#content').html(data);
        });
    });
    $('#allottee_to_allottee_form_check').click(function(){
    ...
    $("#expired_invoices").on('click', function() {
        ...
        $.get('sale/transfer/allottee_to_allottee_expired_invoices.php', function(data,status){
                $("#content").html(data);
        });
    });
