<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Open File Unpaid Registrations</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <!-- <li class="breadcrumb-item"><a class="btn btn-sm"  href = "web-api/logout/logout.php">LOGOUT</a></li> -->
              <li class="breadcrumb-item active"><button class="btn btn-sm" id="unpaid_breadcrumb">Unpaid Open File</button></li>
              <li class="breadcrumb-item"><button class="btn btn-sm" id="open_file_to_allottee_breadcrumb">Open File To Allottee</button></li>
...
$('#example1').ready(function(){
  ...
  $.ajax({
    url: 'api/sales/open_files/unpaid_registration_api.php',
    type: 'POST',
    data: {action: 'index'},
    dataType: "json",
  ...
  function getCurrentDate() {
    ...
    $("#open_file_to_allottee_breadcrumb").on("click", function() {
