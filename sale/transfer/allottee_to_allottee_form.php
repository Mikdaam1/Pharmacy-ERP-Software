    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Allottee To Allottee</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active"><button class="btn btn-sm" id="current_breadcrumb">Allottee To Allotte</button></li>
...
$(document).ready(function () {
    ...
    $.ajax({
        url: 'api/sales/allotte_to_allotte_api.php',
        type: 'POST',
        data: {action: 'customers_allotte',form_no:form_no},
        dataType: "json",
        success: function(response){
            console.log(response);
            $('#buyer_id').html('');
        ...
        if ($("#transfer_form").valid()) {
            $.ajax({
                ...
                success: function(response){
                    ...
                    {
                        console.log(response);
                        // printChallan(response.data['FORM_NO']);
