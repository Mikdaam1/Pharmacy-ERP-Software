        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><button class="btn btn-sm" id="view_breadcrumb"> Final Printed</button></li>
...
$('#example1').ready(function(){
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {action: 'final_printed_allottee'},
        dataType: "json",
        ...
        console.log(response);
            $("#ajax-loader").hide();
              ...
              for (var i = 0; i < response.length; i++) {
                  ...
                  var final_date = response[i].FINAL_DATE;
                  
                  if(jQuery.inArray("402b2e_1", secF_dataArr) !== -1){
                    var btn = '<button type="button" data-id='+trans_req_id+' class="btn btn-approve btn-primary 402b2e_1">Approve</button>';
                  }
                  table.row.add([s_no,sale_id,form_no,req_date,buyer_name,seller_name,final_date]);
              }
              table.draw();
        },
