                                  ...
                                  <table id="example1" class="table table-bordered table-striped table-responsive-lg">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td ><select style="font-size:12px;" name="" id = "type" class="form-control form-control-sm type"><option val="" disabled="readonly" selected>Type</option><option val="NML">NML</option><option val="ADV">ADV</option></select></td>
